...
// both grandparents is dead, add child to them.

class Spouse0Grandparent0 extends StatefulWidget {
  const Spouse0Grandparent0({Key key}) : super(key: key);

  @override
  _Spouse0Grandparent0State createState() => _Spouse0Grandparent0State();
}

class _Spouse0Grandparent0State extends State<Spouse0Grandparent0> {
  List<Child> children = [];
