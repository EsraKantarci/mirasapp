...
class Spouse1Child extends StatefulWidget {
  const Spouse1Child({Key key}) : super(key: key);

  @override
  _Spouse1ChildState createState() => _Spouse1ChildState();
}

class _Spouse1ChildState extends State<Spouse1Child> {
  List<Child> children = [];
