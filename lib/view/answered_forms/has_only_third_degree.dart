...
class OnlyThirdDegree extends StatefulWidget {
  const OnlyThirdDegree({Key key}) : super(key: key);

  @override
  _OnlyThirdDegreeState createState() => _OnlyThirdDegreeState();
}

class _OnlyThirdDegreeState extends State<OnlyThirdDegree> {
  @override
